...
public class GzipFilter implements Filter {
  ...
  public void doFilter(ServletRequest req, ServletResponse rsp,
    ...
    response.addHeader("access-control-allow-headers","accept, accept-charset, accept-encoding, accept-language, authorization, content-length, content-type, host, origin, proxy-connection, referer, user-agent, x-requested-with");
